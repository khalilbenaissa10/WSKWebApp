 ...
 * @author saif
 */
public class AgentSuiviApprentissage extends Agent implements Vocabulary,IAgentSuiviApprentissage {
...
//                                                       no response from the server
      WaitServerResponse(Agent a) {
         ...
         addSubBehaviour(new AgentSuiviApprentissage.ReceiveResponse(myAgent));
...
// --------------------------------------------------------
      ...
      try {
         ...
         addBehaviour(new AgentSuiviApprentissage.WaitServerResponse(this));
      }
